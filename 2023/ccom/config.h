...
#define ASSEMBLER "i86-minix1.7.5-as"

/* Define path to alternate cc2 */
#define CC2 "i86-minix1.7.5-cc2"
...
#define COMPILER "i86-minix1.7.5-ccom"
...
#define LIBDIR "/usr/local/i86-minix1.7.5/lib/"

/* Use libvmf. */
/* #undef LIBVMF */

/* Define path to alternate linker */
#define LINKER "i86-minix1.7.5-ld"
...
#define PREPROCESSOR "i86-minix1.7.5-cpp"
...
#define STDINC "/usr/local/i86-minix1.7.5/include"
...
/* Target string */
#define TARGSTR "i86-pc-minix1.7.5"

/* Enable thread-local storage (TLS). */
/* #undef TLS */

/* Version string */
#define VERSSTR "Portable C Compiler 1.2.0.DEVEL 20221216 for i86-pc-minix1.7.5"
