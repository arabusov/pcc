...
/* operand types */
#define t_norm	1	/* ordinary operand */
#define t_reg	2	/* register */
#define t_imm	3	/* immediate operand */
#define t_sxt	4	/* sign extendable immediate operand */
#define t_indr	5	/* indirect through register */
#define t_ix	6	/* indexed with word offset */
#define t_six	7	/* indexed with sign extendable offset */
#define t_string 8	/* arguments to .ascii, .asciz pseudo ops */
#define t_short	020	/* set if byte operand */
#define t_ind	040	/* indirect through memory */
#define t_type	017	/* used to mask type bits */
...
#define skips(p) while (cinfo[*p]&T || *p=='$') p++
...
#define SOP 0x0F	/* sign-extendable operand */
#define EOS 0x10	/* end of statement */
#define CHR 0x11	/* character constant */
#define DIV 0x12	/* divide */
